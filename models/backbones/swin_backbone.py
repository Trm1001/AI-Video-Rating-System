...
class SwinTransformer3D(nn.Module):
    ...
    def __init__(
        self,
        pretrained='pretrained_weights/swin_tiny_patch244_window877_kinetics400_1k.pth',
        pretrained2d=False,
        patch_size=(2, 4, 4),
        in_chans=3,
        embed_dim=96,
    ...
    def forward(self, batch, multi=False, layer=-1, adaptive_window_size=False):
...
SwinTransformer3D(window_size=(8, 7, 7),)